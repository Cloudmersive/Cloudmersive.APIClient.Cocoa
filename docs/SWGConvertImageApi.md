...
------------- | ------------- | -------------
[**convertImageImageFormatConvert**](SWGConvertImageApi.md#convertimageimageformatconvert) | **POST** /convert/image/{format1}/to/{format2} | Image format conversion
...
SWGConvertImageApi*apiInstance = [[SWGConvertImageApi alloc] init];
...
[apiInstance convertImageImageFormatConvertWithFormat1:format1
          ...
          completionHandler: ^(NSURL* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling SWGConvertImageApi->convertImageImageFormatConvert: %@", error);
                        }
                    }];
```
