...
@interface SWGNsfwApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGNsfwApi

NSString* kSWGNsfwApiErrorDomain = @"SWGNsfwApiErrorDomain";
NSInteger kSWGNsfwApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) nsfwClassifyWithImageFile: (NSURL*) imageFile
    ...
    if (imageFile == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGNsfwApiErrorDomain code:kSWGNsfwApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
