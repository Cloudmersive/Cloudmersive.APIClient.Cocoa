...
@interface SWGScanApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGScanApi

NSString* kSWGScanApiErrorDomain = @"SWGScanApiErrorDomain";
NSInteger kSWGScanApiMissingParamErrorCode = 234513;
...
///
///  @returns SWGInlineResponse20019*
///
-(NSURLSessionTask*) scanFileWithInputFile: (NSURL*) inputFile
    ...
    if (inputFile == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGScanApiErrorDomain code:kSWGScanApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGInlineResponse20019*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGInlineResponse20019*)data, error);
                                }
                            }];
}
