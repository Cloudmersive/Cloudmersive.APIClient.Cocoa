...
@interface SWGFaceApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGFaceApi

NSString* kSWGFaceApiErrorDomain = @"SWGFaceApiErrorDomain";
NSInteger kSWGFaceApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) faceCropFirstWithImageFile: (NSURL*) imageFile
    ...
    if (imageFile == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGFaceApiErrorDomain code:kSWGFaceApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
