#import "SWGPosTaggerStringApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"


@interface SWGPosTaggerStringApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGPosTaggerStringApi

NSString* kSWGPosTaggerStringApiErrorDomain = @"SWGPosTaggerStringApiErrorDomain";
NSInteger kSWGPosTaggerStringApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) posTaggerStringPostWithInput: (NSString*) input
    ...
    if (input == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGPosTaggerStringApiErrorDomain code:kSWGPosTaggerStringApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/nlp/PosTaggerString"];
