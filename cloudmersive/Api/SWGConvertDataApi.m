#import "SWGConvertDataApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"


@interface SWGConvertDataApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGConvertDataApi

NSString* kSWGConvertDataApiErrorDomain = @"SWGConvertDataApiErrorDomain";
NSInteger kSWGConvertDataApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) convertDataCsvToJsonWithInputFile: (NSURL*) inputFile
    ...
    if (inputFile == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGConvertDataApiErrorDomain code:kSWGConvertDataApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
