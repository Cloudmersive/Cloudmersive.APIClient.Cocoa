#import "SWGImageOcrApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGInlineResponse20013.h"


@interface SWGImageOcrApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGImageOcrApi

NSString* kSWGImageOcrApiErrorDomain = @"SWGImageOcrApiErrorDomain";
NSInteger kSWGImageOcrApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) imageOcrPostWithImageFile: (NSURL*) imageFile
    ...
    if (imageFile == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGImageOcrApiErrorDomain code:kSWGImageOcrApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
