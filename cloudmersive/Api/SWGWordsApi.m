...
NSString* kSWGWordsApiErrorDomain = @"SWGWordsApiErrorDomain";
NSInteger kSWGWordsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) wordsAdjectivesWithInput: (NSString*) input
    ...
    if (input == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGWordsApiErrorDomain code:kSWGWordsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/nlp/get/words/adjectives/string"];
...
-(NSURLSessionTask*) wordsAdverbsWithInput: (NSString*) input
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/nlp/get/words/adverbs/string"];
...
-(NSURLSessionTask*) wordsGetWordsJsonWithInput: (NSString*) input
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/nlp/get/words/json"];
...
-(NSURLSessionTask*) wordsGetWordsStringWithInput: (NSString*) input
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/nlp/get/words/string"];
...
-(NSURLSessionTask*) wordsNounsWithInput: (NSString*) input
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/nlp/get/words/nouns/string"];
...
-(NSURLSessionTask*) wordsPostWithInput: (NSString*) input
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/nlp/get/words/verbs/string"];
...
-(NSURLSessionTask*) wordsPronounsWithInput: (NSString*) input
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/nlp/get/words/pronouns/string"];
...
-(NSURLSessionTask*) wordsProperNounsWithInput: (NSString*) input
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/nlp/get/words/properNouns/string"];
