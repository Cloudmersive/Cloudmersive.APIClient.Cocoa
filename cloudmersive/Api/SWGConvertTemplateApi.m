#import "SWGConvertTemplateApi.h"
...
@interface SWGConvertTemplateApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGConvertTemplateApi

NSString* kSWGConvertTemplateApiErrorDomain = @"SWGConvertTemplateApiErrorDomain";
NSInteger kSWGConvertTemplateApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) convertTemplateApplyHtmlTemplateWithValue: (SWGValue*) value
    ...
    if (value == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGConvertTemplateApiErrorDomain code:kSWGConvertTemplateApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
