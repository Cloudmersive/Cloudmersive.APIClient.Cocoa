#import "SWGParseStringApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"


@interface SWGParseStringApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGParseStringApi

NSString* kSWGParseStringApiErrorDomain = @"SWGParseStringApiErrorDomain";
NSInteger kSWGParseStringApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) parseStringPostWithInput: (NSString*) input
    ...
    if (input == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGParseStringApiErrorDomain code:kSWGParseStringApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/nlp/ParseString"];
