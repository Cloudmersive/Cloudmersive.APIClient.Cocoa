#import "SWGSentencesApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"


@interface SWGSentencesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGSentencesApi

NSString* kSWGSentencesApiErrorDomain = @"SWGSentencesApiErrorDomain";
NSInteger kSWGSentencesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) sentencesPostWithInput: (NSString*) input
    ...
    if (input == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGSentencesApiErrorDomain code:kSWGSentencesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/nlp/get/sentences/string"];
