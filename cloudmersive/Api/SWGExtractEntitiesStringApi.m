#import "SWGExtractEntitiesStringApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"


@interface SWGExtractEntitiesStringApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGExtractEntitiesStringApi

NSString* kSWGExtractEntitiesStringApiErrorDomain = @"SWGExtractEntitiesStringApiErrorDomain";
NSInteger kSWGExtractEntitiesStringApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) extractEntitiesStringPostWithValue: (NSString*) value
    ...
    if (value == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGExtractEntitiesStringApiErrorDomain code:kSWGExtractEntitiesStringApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
