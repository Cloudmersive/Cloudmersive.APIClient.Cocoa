...
@interface SWGConvertWebApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGConvertWebApi

NSString* kSWGConvertWebApiErrorDomain = @"SWGConvertWebApiErrorDomain";
NSInteger kSWGConvertWebApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) convertWebHtmlToPdfWithInput: (SWGInput3*) input
    ...
    if (input == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGConvertWebApiErrorDomain code:kSWGConvertWebApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
