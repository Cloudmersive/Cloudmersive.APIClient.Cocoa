#import "SWGRecognizeApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"
#import "SWGInlineResponse20017.h"


@interface SWGRecognizeApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGRecognizeApi

NSString* kSWGRecognizeApiErrorDomain = @"SWGRecognizeApiErrorDomain";
NSInteger kSWGRecognizeApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) recognizeDescribeWithImageFile: (NSURL*) imageFile
    ...
    if (imageFile == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGRecognizeApiErrorDomain code:kSWGRecognizeApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
